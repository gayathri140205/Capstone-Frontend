...
function Signin() {
 ...
 {loading && (
      ...
      <section>
      <div className='logfull'  style={{ backgroundColor: '#3B5998', height: '100vh' }} >
      <div className="login" style={{backgroundColor: 'WHITE',height:"630px",paddingTop:"35px"} }>
      <div className="avatar" style={{width:"100px", height:"100px"}}>
        <img src={icon} />
      </div>
      <h2 style={{ color: '#007acc' }}>Login</h2>
<h3 style={{ color: '#007acc' }}>Welcome back!</h3>
